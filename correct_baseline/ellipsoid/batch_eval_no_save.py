...
from correct_baseline.ellipsoid.baseline import merge_error_correction, split_error_correction
...
def main():
    ...
    offsets_json = os.path.join(base_dir, "slice_offsets_mid_dx.json") if "merge_error" in base_dir else os.path.join(base_dir, "slice_offsets.json")
    iou_threshold = 0.75
